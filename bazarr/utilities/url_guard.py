...
def assert_safe_outbound(url: str) -> None:
    ...
    reserved, or non-http(s) destinations. Must run BEFORE requests.get and
    be re-verified after any redirect."""
    ...
    # Try as literal IP first; fall back to DNS resolution.
    try:
